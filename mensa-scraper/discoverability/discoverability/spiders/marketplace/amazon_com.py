...
class AmazonComDiscStyleList(AbstractStyleList):
    ...
    def clean(self, selection, **kwargs) -> List[DiscoverabilityStyleItem]:
        ...
        for style_selection in selection:
            ...
            if not asin_product_href.match(style_href):
                ...
                sponsored = True
            style_href = f"https://www.amazon.com{style_href}"
            ...
            style_item = DiscoverabilityStyleItem(skuid=skuid, brand=brand_formatted_name(brand), name=name,
                                                  ...
                                                  channel=ChannelType.AmazonCom, rank_sponsored=str(rank_sponsored),
...
def build_style_list_url(keyword: str, sort: SortOption) -> str:
    ...
    return f'https://www.amazon.com/s?k={url_search_text}&ref={sort_option}'
...
class AmazonCom(AbstractMarketplace):
    ...
    def parse_style_list(self) -> AmazonComDiscStyleList:
        return AmazonComDiscStyleList()
