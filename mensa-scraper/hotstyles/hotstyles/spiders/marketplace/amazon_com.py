...
def build_style_list_urls(sku_ids: List[str]) -> List[str]:
    return [f'https://www.amazon.com/dp/{skuid}/' for skuid in sku_ids]


class AmazonCom(AbstractMarketplace):
    smart_proxy = None
    ...
    def extract_style(self, response, **kwargs):
        ...
        yield HotstylesItem(skuid=skuid, name=name, channel=ChannelType.AmazonCom,
