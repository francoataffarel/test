...
class HotstylesSpider(scrapy.Spider):
    name = 'hotstyles_spider'
    allowed_domains = ['amazon.in', 'amazon.com', 'amazon.ae', 'amazon.ca', 'myntra.com', 'flipkart.com', 'ajio.com']
    marketplace = None
    ...
    def __init__(self, name=None, **kwargs):
        ...
        if marketplace not in self.allowed_domains:
            ...
            self.marketplace_object = self.__marketplace_factory(domain=marketplace, proxy=self.proxy)
