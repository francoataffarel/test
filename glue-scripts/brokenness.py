...
product_table = input_df.select('skuid', 'brand', 'channel', 'name', 'product_href', 'total_skus',
                                'available_skus', 'score', 'extracted_date')
...
### Write to Redshift
#########################################
print("Writing to Redshift brand_analytics.brokenness_product table")
glueContext.write_dynamic_frame.from_jdbc_conf(
    frame=DynamicFrame.fromDF(product_table, glueContext, 'product'),
    catalog_connection=REDSHIFT_DB,
    connection_options={
        "dbtable": "brand_analytics.brokenness_product",
