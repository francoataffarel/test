...
args = getResolvedOptions(sys.argv, ['GLUE_DB', 'GLUE_DISC_TABLE', 'GLUE_RDS_DB', 'GLUE_RDS_TABLE', 'JOB_NAME', 'ROLE_ARN', 'REDSHIFT_DB'])

GLUE_DB = args['GLUE_DB']
GLUE_DISC_TABLE = args['GLUE_DISC_TABLE']
...
print(f"Reading data from {GLUE_DISC_TABLE}")
...
input_df = input_df.select('keyword', 'skuid', 'brand', 'channel', 'name', 'product_href', 'extracted_date', 'price',
                           'mrp', 'discount', 'rating', 'rating_count', 'rank', 'page', 'sort', 'sponsored',
                           'rank_sponsored', 'brand_type')
...
glueContext.write_dynamic_frame.from_jdbc_conf(
    ...
    connection_options={
        "dbtable": "brand_analytics.discoverability_product",
